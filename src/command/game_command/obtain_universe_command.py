...
def handle_obtain_universe(command_data, answer_command_data):
    ...
    starbase_data['sid'] = 1
    starbase_data['upgradeId'] = 0  # Count of upgrade (basically level - 1)
    ...
    bank_data = {}
    bank_data['sku'] = 'rs_002_001'
    bank_data['sid'] = 2
    bank_data['upgradeId'] = 0  # Count of upgrade (basically level - 1)
    bank_data['time'] = 0
    bank_data['state'] = 1
    bank_data['x'] = 0
    bank_data['y'] = 0
    bank_data['isFlipped'] = 0
    bank_data['repairing'] = 0
    bank_data['incomeToRestore'] = 0
    bank_data['energy'] = 800000  # building health

    items_data['Items'].append(bank_data)
